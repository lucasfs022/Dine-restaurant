...
const events = document.querySelectorAll('div.gathering-event');
const underlines = document.querySelectorAll('div.gathering-lines');

const breakPoints = [614, 1024];
