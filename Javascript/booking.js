...
const dropdownItems = document.querySelectorAll('.dropdown-menu-items');
const selectedMeridiem = document.getElementById('dropdown-day');
const dropdownTrigger = document.getElementById('dropdown-wrapper');
const dropdownArrow = document.getElementById('dropdown-arrow');

// vars for number picker
const numberOfPeople = document.getElementById('num-of-people-label');
